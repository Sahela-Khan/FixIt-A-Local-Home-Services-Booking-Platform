  ...
  return (
    <div className="flex-1 bg-slate-50 p-8">
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm mb-6">
        ...
        <p className="text-sm text-slate-500 mb-1">
          Cancelling a booking costs 10 points on your 1st cancellation, 20 on your 2nd, 30 on your 3rd —
          increasing by 10 each time (capped at 30). Cancelling before the provider accepts costs nothing.
        </p>
